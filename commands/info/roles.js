...
exports.run = (client, message, args) => {
    ...
    try {
        ...
        let embed = new Discord.RichEmbed()
            ...
            .addField('Add roles using pls with `pls addrole <role name>`', 'Note: Only roles below the \`Coding Yabe Sei\` role are displayed')
            .setTimestamp();
...
exports.help = {
    ...
    type: "info",
    name: "roles",
    description: "The `roles` command displays all roles below the \`Coding not dank memer\` role.",
    usage: "`pls roles`"
}
